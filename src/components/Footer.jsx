    ...
    return (
        <div>
            <footer class="footer-bg bg-blue2">
                <Container>
                    <p class="ff-poppins fw-semibold fs-xl text-center lh-124 color-white  pt-58">JOIN US</p>
                    <Row>
                        ...
                        <Col lg={5} className='pt-5'>
                            <Row className='pt-5'>
                                <Col className='pt-lg-247 pt-sm-0 pl-1'>
                                ...
                                <Col className='pt-lg-247 pt-sm-0'>
